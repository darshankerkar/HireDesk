...
import { ArrowRight, CheckCircle, Upload, Cpu, ShieldCheck, Users, Zap, Target, TrendingUp, Lock, FileSpreadsheet } from 'lucide-react';
        ...
        <section className="py-24 bg-dark">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="relative p-8 bg-surface rounded-2xl border border-gray-800 hover:border-primary transition-colors duration-300 overflow-hidden">
